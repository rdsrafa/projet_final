<?php
// include/sidebar.php - Barre latérale de navigation
...
<aside class="sidebar">
    ...
    <nav>
        ...
        <!-- RH avec sous-menu -->
        <a href="index.php?module=rh&action=personnel" class="nav-item <?php echo $current_module === 'rh' ? 'active' : ''; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <span>RH & Personnel</span>
        </a>
        <a href="index.php?module=admin&action=suppliers" class="nav-item <?php echo ($current_module === 'admin' && $current_action === 'suppliers') ? 'active' : ''; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div style="margin-top: 2rem; padding: 0 2rem; border-top: 1px solid var(--glass-border); padding-top: 1rem;">
